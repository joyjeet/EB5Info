...
export async function generateMetadata({ params }: IntentPageProps): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `/${locale}/can-i-get-eb-5-money-back`,
    },
    openGraph: {
      title: page.seo.title,
      description: page.seo.description,
...
export default async function MoneyBackPage({ params }: IntentPageProps) {
  const { locale } = await params;
  ...
  const breadcrumbStructuredData = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 2,
        name: page.title,
        item: withBaseUrl(`/${locale}/can-i-get-eb-5-money-back`),
      },
    ],
  };
    ...
    <main className="page-shell standalone-page-shell">
      ...
      <section className="content-section standalone-hero">
        ...
        <div className="section-heading narrow-heading">
          <p className="section-kicker">EB-5 Return</p>
